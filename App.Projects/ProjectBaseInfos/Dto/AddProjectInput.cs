...
namespace App.Projects.ProjectBaseInfos.Dto
{
    public class AddProjectInput
    {
        ...
        /// 项目地址
        /// </summary>
        public AddProjectLocationInput Location { get; set; }

        /// <summary>
        /// 项目成员
        /// </summary>
        public List<AddProjectMemberInput> Members { get; set; }

        /// <summary>
        /// 项目参与单位
        /// </summary>
        public List<AddProjectUnitInput> Units { get; set; }
        ...
        {
            Members = new List<AddProjectMemberInput>();
            Attachments = new List<AddAttachmentFileMetaInput>();
            Units = new List<AddProjectUnitInput>();
        }
    }
}
